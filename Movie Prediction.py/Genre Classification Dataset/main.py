...
#here we have imported  all the libraries that is needed for the task
...
# Here we have a fallback_genre for the time the model finds the genre hard to predict
